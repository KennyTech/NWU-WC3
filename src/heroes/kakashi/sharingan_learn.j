...
function InitTrig_Sharingan_Learn takes nothing returns nothing
    set gg_trg_Sharingan_Learn = CreateTrigger(  )
    call DisableTrigger( gg_trg_Sharingan_Learn )
    call TriggerRegisterAnyUnitEventBJ( gg_trg_Sharingan_Learn, EVENT_PLAYER_HERO_SKILL )
    call TriggerAddCondition( gg_trg_Sharingan_Learn, Condition( function Trig_Sharingan_Learn_Conditions ) )
    call TriggerAddAction( gg_trg_Sharingan_Learn, function Trig_Sharingan_Learn_Actions )
endfunction