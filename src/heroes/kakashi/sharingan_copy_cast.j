function Trig_Sharingan_Copy_Actions takes nothing returns nothing
...
//===========================================================================
function Trig_Sharingan_Copy_Conditions takes nothing returns boolean
    return GetSpellAbilityId() == 'A03G'
endfunction
function InitTrig_Sharingan_Copy_Cast takes nothing returns nothing
    set gg_trg_Sharingan_Copy_Cast = CreateTrigger(  )
    call DisableTrigger( gg_trg_Sharingan_Copy_Cast )
    call TriggerRegisterAnyUnitEventBJ( gg_trg_Sharingan_Copy_Cast, EVENT_PLAYER_UNIT_SPELL_EFFECT )
    call TriggerAddCondition( gg_trg_Sharingan_Copy_Cast, Condition( function Trig_Sharingan_Copy_Conditions ) )
    call TriggerAddAction( gg_trg_Sharingan_Copy_Cast, function Trig_Sharingan_Copy_Actions )
endfunction