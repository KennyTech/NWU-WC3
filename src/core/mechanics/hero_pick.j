library HeroPick initializer Init requires TimerUtils
    ...
    //      call EnableTrigger( gg_trg_Chouyi_Baika_No_Jutsu )
        ...
        elseif UnitType==DEIDARA then//***DEIDARA***
            call ExecuteFunc("DeiC3Ult_Init")
            call ExecuteFunc("DeiClaySpider_Init")
            call ExecuteFunc("DeiKatsuCast_Init")
            call ExecuteFunc("DeiKatsuLearn_Init")
            call ExecuteFunc("DeiKatsuReady_Init")
            call ExecuteFunc("DeiMineDeath_Init")
            call ExecuteFunc("DeiMineThrow_Init")
            debug call Test_Success("Deidara Initialized")
